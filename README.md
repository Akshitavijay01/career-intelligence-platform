...
5. Wait ~5-10 minutes. You'll get URLs:
   - Frontend: `https://career-intelligence-frontend-sb8a.onrender.com`
   - Backend API: `https://career-intelligence-api-b7ee.onrender.com`
   - Swagger docs: `https://career-intelligence-api-b7ee.onrender.com/docs`
...
- **Backend web service:**
  ...
  - Env vars: `DATABASE_URL` (from Render Postgres), `SECRET_KEY` (random), `CORS_ORIGINS` → `https://career-intelligence-frontend-sb8a.onrender.com`
- **Frontend static site:**
  - Root directory: `frontend`
  - Build: `npm install && npm run build`
  - Publish directory: `dist`
  - Env var: `VITE_API_URL` → `https://career-intelligence-api-b7ee.onrender.com/api`
